        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Portofolio Lengkap</h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Seluruh proyek aplikasi yang telah kami kembangkan untuk membantu mahasiswa menyelesaikan tugas akhir mereka
              </p>
            ...
            {filteredProjects.length === 0 && (
              <div className="text-center py-20">
                <p className="text-gray-500 text-lg">Belum ada proyek untuk kategori ini.</p>
              </div>
            )}
          </div>
        </section>
